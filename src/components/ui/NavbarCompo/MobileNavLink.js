...
const MobileNavLink = ({ link }) => {
  ...
  return (
    <div
      className={`w-full ${user || (link?.path === "/dashboard" && "hidden")}`}
    >
      <Link
        className={
