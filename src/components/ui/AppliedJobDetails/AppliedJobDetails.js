  ...
  return (
    <div className="rounded ">
      <div className="p-5 bg-primaryColor border border-primaryColor">
        <h1 className="text-whiteColor text-2xl font-semibold">Your Submission</h1>
      </div>
     <div className="border rounded bg-lightWhiteColor">
      <div className="px-5 flex justify-between mt-3">
      <h3 className="text-darkColor font-semibold text-xl ">Your Cover Letter</h3>
     ...
     <div
      ...
      <div className="flex items-center p-5 gap-5 md:gap-10">
        <div className="flex">
          ...
          <p className="ml-2">{appliedJobDetails?.fileName?.slice(0, 20)}... <br /> {appliedJobDetails?.size}</p>
        </div>
        <AppliedJobButton
