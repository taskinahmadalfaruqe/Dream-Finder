    ...
    <div className="space-y-4 xl:space-y-6">
        ...
        <div className="space-y-2">
            <div className="flex justify-center items-center flex-col space-y-2 text-lg font-medium leading-6">
                ...
                <div className="flex justify-center mt-5 space-x-8"><a title="connect with X" href="#" target="_blank" rel="noopener noreferrer"
                        className="inline-block text-gray-400"><svg
                            stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512"
                            className="w-7 h-7 text-secondaryColor hover:text-primaryColor"  height="1em" width="1em"
                        ...
                        </svg></a><a title="connect with github" href="#" target="_blank" rel="noopener noreferrer"
                        className="inline-block text-gray-400"><svg stroke="currentColor"
                    ...
                    <a title="connect with linkedin" href="#" target="_blank" rel="noopener noreferrer"
                        className="inline-block text-gray-400"><svg
